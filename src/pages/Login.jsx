...
const Login = () => {
  ...
  return (
    <div className='flex h-[100vh]  justify-center gap-5 flex-wrap   items-center '>
      <div className='border-[2px] border-solid bg-pink-100 p-5 rounded-tl-[100px] rounded-br-[100px] mt-[100px] '>
        <div className='h-[400px] w-[300px] flex justify-evenly flex-col ml-5 '>
          <div> <label htmlFor="" className='font-bold text-[20px] '>Email *</label><br />
            <input type="text" placeholder=' Enter your email' className='w-[300px] border-2 text-center border-orange-400 h-[40px] rounded-[5px]' /></div>
          <div> <label htmlFor="" className='font-bold text-[20px]'>Password *</label><br />
            <input type="password" placeholder=' Enter your password' className='w-[300px] border-2 text-center  border-orange-400 h-[40px] rounded-[5px]' />
          </div>

          <button className='w-[300px] bg-orange-500 rounded-[20px] h-[40px] font-bold'>Log in </button>

          <button type="button" class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l  focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-full text-sm px-10 py-2.5 text-center ">Create New Account</button>
      ...
      <div className="flex flex-col justify-evenly  h-[350px] w-[250px] ">
